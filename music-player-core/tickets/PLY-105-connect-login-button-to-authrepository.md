# Connect Login Button to AuthRepository

**Objective**
Update login button click handler in auth.kt to call AuthRepository.authenticate() instead of test stub. Single UI connection change. following test-driven development approach.
...
**Task**
Update login button click handler in auth.kt to call AuthRepository.authenticate() instead of test stub. Single UI connection change. using TDD methodology:
...
- **Ticket**: PLY-105
- **PR**: https://github.com/appmancer/FoxyPlayer/pull/34
- **Domain**: music-player-core
- **TDD Cycles**: 1 completed
- **Tests**: 0 passing
- **Files Changed**: 1
- **Merged**: 2025-09-01T10:34:36+01:00
- **Branch**: feature/PLY-105-connect-login-button-to-authrepository (deleted)
