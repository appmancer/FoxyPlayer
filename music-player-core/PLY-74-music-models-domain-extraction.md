# Music Models Domain Extraction

**Objective**
Extract music-related data models and DTOs from music.kt into music-models.kt following test-driven development approach.
...
**Task**
Extract music-related data models and DTOs from music.kt into music-models.kt using TDD methodology:
